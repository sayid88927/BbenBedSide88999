...
public class ColorPickerView extends View {
    ...
    private onCheckRgbClick onCheckRgbClick;

    public interface onCheckRgbClick {
        void onCheckRgbClick(int  item);
    }

    public void onCheckRgbClick(onCheckRgbClick onCheckRgbClick) {
        this.onCheckRgbClick = onCheckRgbClick;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()){
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                curRGBColor = getPointColor();
                if(onCheckRgbClick!=null){
                    onCheckRgbClick.onCheckRgbClick(curRGBColor);
                }
